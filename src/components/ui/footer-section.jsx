...
export function Footer() {
    return (
        <footer className="relative w-full max-w-[1400px] mx-auto flex flex-col items-center justify-center border-t border-white/10 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.purple.500/10%),transparent)] px-6 py-16 lg:py-24 md:rounded-t-[3rem] text-white">
            {/* Top glowing line */}
            ...
            <div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-8 justify-items-center text-center">
                <AnimatedContainer className="space-y-6 flex flex-col items-center">
                    ...
                    <p className="text-gray-400 mt-8 text-base md:mt-0 max-w-sm">
                ...
                <div className="mt-10 grid grid-cols-2 gap-10 md:grid-cols-4 xl:col-span-2 xl:mt-0 w-full justify-items-center">
                    {footerLinks.map((section, index) => (
                        <AnimatedContainer key={section.label} delay={0.1 + index * 0.1}>
                            <div className="mb-10 md:mb-0 flex flex-col items-center">
                                <h3 className="text-lg font-bold text-purple-300 mb-6">{section.label}</h3>
                                    ...
                                    {section.links.map((link) => (
                                        <li key={link.title}>
                                            <a
                                                ...
                                                className="hover:text-white hover:scale-105 inline-flex items-center justify-center transition-all duration-300"
                                            >
                                                {link.icon && <link.icon className="me-2 size-5 text-purple-400" />}
                                                {link.title}
                                            </a>
                                        </li>
                                    ))}
