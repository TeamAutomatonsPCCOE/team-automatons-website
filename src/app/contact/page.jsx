                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4 text-slate-300 hover:text-white transition-colors group">
                                    ...
                                    <div>
                                        ...
                                        <a
                                            href="https://mail.google.com/mail/?view=cm&fs=1&to=automatons.robotics@gmail.com"
                                            target="_blank"
                                ...
                                <div className="flex items-start gap-4 text-slate-300 hover:text-white transition-colors group">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919561014589" className="hover:text-purple-300 transition-colors">
                                            +91 9561014589
                                        </a>
                                    </div>
                                </div>
